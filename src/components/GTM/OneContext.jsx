...
const CONTENT = {
  heading: 'One context, every tool you use',
  body: "You use ChatGPT for some things and Claude for others - Unabyss makes sure both know what's happening across your GTM. The full picture follows you into every AI tool, and into your automations in Make, n8n, and Zapier.",
