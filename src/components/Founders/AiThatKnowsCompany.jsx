      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        ...
        <div>
          ...
          <p className="text-white/50 leading-relaxed mb-8 max-w-md">
            ...
            knows the whole business. Unabyss gives every AI tool you use
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              Ask for what your team did this week, their priorities for
              next week, and the blockers that need your attention - and AI
              pulls it straight from your company's context instead of you
              stitching it together from Slack threads and standups.
            </p>
          </div>
        </div>
      </div>
