import claudesvg from '../assets/logos/claude.svg'
...
export default function LogoStrip() {
  ...
  BACKED BY{' '}
  <span className="font-bold text-white/50 text-xl">
    <span className="text-balance text-md tracking-tighter text-white/80 pb-1.5">||</span>
    <span className="text-white/80">ElevenLabs</span>
    <span className="font-thin text-white/80 tracking-tighter">Grants</span>
  </span>
</p>
    </div>
  )
