    ...
    >
      ...
      <div className="flex items-center gap-3.5 mb-5">
        ...
        <div className="min-w-0">
          <p className="text-[15px] font-semibold leading-tight text-white/90 truncate">
            {person.name}
          </p>

          <p className="mt-1 text-[13px] leading-none text-white/35 truncate">
            {person.role}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4 sm:gap-[18px] w-full min-w-0">
