...
/* =========================================================
   SECTION CONFIG
   Change these values to resize the composition.
   ========================================================= */
...
const SIDE_CARDS = [
  ...
  {
    title: 'Audit trail.',
    desc: 'Every context request logged: what was shared, with whom, when.',
  },
  {
    title: 'Access inherited, not invented.',
    desc: 'Context is bounded by the source permissions your company already maintains.',
  },
]
...
function OwnershipCard() {
  return (
    <SpotlightContainer
      ...
      "
      style={{
        height: CONTEXT_SECTION.featuredHeight,
      }}
    >
      <h3
        className="
      ...
      <p
        ...
        "
      >
        Unabyss is an independent context layer - not
      ...
      >
        ...
        >
          ...
          <div className="min-w-0">
            ...
            >
              <InfoCard
                title={SIDE_CARDS[2].title}
                desc={SIDE_CARDS[2].desc}
                height={CONTEXT_SECTION.bottomCardHeight}
              />
            </div>
          ...
          <div className="min-w-0">
            ...
            >
              <InfoCard
                title={SIDE_CARDS[0].title}
                desc={SIDE_CARDS[0].desc}
                height={CONTEXT_SECTION.sideCardHeight}
              />
            </div>
            ...
            >
              <InfoCard
                title={SIDE_CARDS[1].title}
                desc={SIDE_CARDS[1].desc}
                height={CONTEXT_SECTION.sideCardHeight}
              />
            </div>
            ...
            >
              <InfoCard
                title={SIDE_CARDS[3].title}
                desc={SIDE_CARDS[3].desc}
                height={CONTEXT_SECTION.bottomCardHeight}
              />
            </div>
        ...
        >
          <a
            ...
            "
            style={{
              height: CONTEXT_SECTION.ctaHeight,
            }}
          >
            <span>
