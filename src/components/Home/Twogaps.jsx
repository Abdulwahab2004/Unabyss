...
function IconChip({ tool }) {
  return (
    <div
      className="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-white/5"
      title={tool.name}
    >
      {tool.logoUrl ? (
        <img
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 grid gap-4 md:grid-cols-2">
        ...
        <div
          data-scroll
          className="scroll-reveal rounded-2xl border border-white/10 bg-badge p-8"
        >
      ...
      <div
        data-scroll
        className="scroll-reveal grid overflow-hidden rounded-3xl border border-white/10 bg-badge md:grid-cols-2"
      >
