      ...
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div className="min-w-0">
          ...
          <p className="mb-8 max-w-md leading-relaxed text-white/50">
            You wire up Claude, Cursor, Codex, or n8n - and every one starts
            from zero. Unabyss gives them one shared context, so what one
            knows, they all know.
          </p>
        ...
        <div className="min-w-0">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://unabyss.com/_app/immutable/assets/blog-cover-04.DIUaWazw.webp')",
              }}
              aria-hidden="true"
            />
          ...
          <div className="mt-5 sm:mt-6">
            ...
            <p className="text-sm leading-relaxed text-white/50">
              You worked through GCP vs AWS in Cursor this morning. Open Claude
              and it already knows why you chose GCP, what you rejected, and
              whether current costs mean it's time to reconsider - without
