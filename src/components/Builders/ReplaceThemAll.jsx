...
const CONTENT = {
  heading: 'Replace them all with one MCP connection',
  body: "Replace them all with one MCP connection that stays current automatically. Your context updates itself from GitHub, Linear, Notion - it never goes stale, and you never re-upload it to another tool again.",
