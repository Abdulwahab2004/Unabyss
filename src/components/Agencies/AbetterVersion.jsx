...
const CONTENT = {
  heading: 'A better version of your .md files',
  body: "Keep the per-client context your .md files give you - just stop maintaining it by hand. Unabyss stays current automatically, includes the live relationship, and follows you into every AI tool.",
  cta: { label: 'Connect your first client', href: '#' },
}
...
export default function AbetterVersion() {
  return (
